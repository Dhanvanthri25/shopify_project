...
export function Watches() {
    ...
    useEffect(() => {
        fetch("http://localhost:2500/WatchProduct")
    ...
    return (
        <>
            <div className="backs">
            <h1 className="text-center tit">Watch Products</h1>
                    ...
                    details.map((value, index) => (
                        <>
                            ...
                            <div className="card col-lg-2 text-center d-inline-flex m-3" >
                                ...
                                {/* <Link to ={`/WatchDetails/${value.id}`}><input type = "button" value = "View Details" className="btn btn-secondary"/></Link> */}
                                <div className="">
