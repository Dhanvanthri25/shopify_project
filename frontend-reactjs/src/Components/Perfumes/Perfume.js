...
export function Perfumes(){
    ...
    useEffect(() => {
        fetch("http://localhost:2500/PerfumeProduct")
    ...
    return(
        <>
        <div className="backs">
        <h1 className="text-center tit">Perfume Products</h1>
                    ...
                    <>
                        ...
                        <div className="card col-lg-2 text-center d-inline-flex m-3" >
                            <img src={value.imageURL} className="card-img-top" alt="..."/>
                                ...
                                {/* <Link to ={`/PerfumeDetails/${value.id}`}><input type = "button" value = "View Details" className="btn btn-secondary"/></Link> */}
                                <div className="">
