...
export function Kids(){
    ...
    useEffect(() => {
        fetch("http://localhost:2500/KidProduct")
    ...
    return(
        <>
        <div className="backs">
        <h1 className="text-center tit">Kids Product</h1>
                    ...
                    <>
                        ...
                        <div className="card col-lg-2 text-center d-inline-flex m-3" >
                            <img src={value.imageURL} className="card-img-top" alt="..."/>
                                ...
                                {/* <Link to ={`/KidDetails/${value.id}`}><input type = "button" value = "View Details" className="btn btn-secondary"/></Link> */}
                                <div className="">
